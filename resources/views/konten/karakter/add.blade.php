                        ...
                        <div class="card-body">
                            <form action="{{route('characters.store')}}" method="POST">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="row-sm-9">
                                        <input type="text" class="form-control" name="title" id="title" placeholder="Type here" required>
                                    </div>
                                </div>
                                <div class="col mb-3">
                                    <div class="row-sm-3">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="row-sm-10">
                                        <textarea class="form-control" name="power" id="power" placeholder="Type here" required></textarea>
                                    </div>
                                </div>
                                <div class="col mb-3">
                                    <div class="row-sm-2">
                                    ...
                                    <div class="row-sm-10">
                                        <textarea class="form-control" name="ket" id="ket" placeholder="Type here" required></textarea>
                                    </div>
                                </div>
